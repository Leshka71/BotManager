...
VIAddVersionKey /LANG=0 "FileVersion" "1.2.2"
VIAddVersionKey /LANG=0 "ProductVersion" "1.2.2"
...
Section "Bot Manager" SecMain
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\BotManager" "DisplayVersion" "1.2.2"
