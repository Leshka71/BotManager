...
VIAddVersionKey /LANG=0 "FileVersion" "1.0.8"
VIAddVersionKey /LANG=0 "ProductVersion" "1.0.8"
...
Section "Bot Manager" SecMain
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\BotManager" "DisplayVersion" "1.0.8"
